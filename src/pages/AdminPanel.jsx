        ...
        {products.map((product) => (
          <Grid item xs={12} sm={6} md={4} key={product.id}>
            <Paper sx={{ p: 2 }}>
              ...
              <Button variant="contained" color="secondary" sx={{ mt: 2 }} onClick={() => handleUpdateProduct(product.id, { name: "Updated Name" })}>Update</Button>
              <Button variant="contained" color="error" sx={{ mt: 2 }} onClick={() => handleDeleteProduct(product.id)}>Delete</Button>
            </Paper>
          </Grid>
        ))}
      </Grid>
